...
public class CustomerRest {
	private static List<CustomerDB> customers = new ArrayList<CustomerDB>();
...
//		customers.add(customer5);
	...
	public List<CustomerDB> getCustomers() {
		return customers;
	}
	...
	@Path("customer")
	@Produces(MediaType.APPLICATION_JSON)
	public CustomerDB getCustomer(@QueryParam("id") long id) {
		
		
		
		domain.customer.entity.CustomerDB c = repo.findById((long) 1);
